...
if __name__ == '__main__':
    df_a = pd.read_csv(r"/data2/kfchen/tracing_ws/14k_raw_img_data/rescaled_1um_swc_l_measure.csv")# resample后的版本
    ...
    # df_b = pd.read_csv(r"/data/kfchen/trace_ws/paper_auto_human_neuron_recon/swc_label/test/auto8.4k_0510_pruned_resample1um.csv")
    ...
    df_b = pd.read_csv(r"/data2/kfchen/tracing_ws/14k_raw_img_data/h01-guided-reconstruction/data/auto8.4k_0510_pruned_resample1um_renamed_0716_l_measure.csv")

    print(df_a.columns)

    violin_file = r"/home/kfchen/neuron_seg_human/neuroutils/tests/071625/lmeasure_violin_weighted.png"
