...
def get_comp_l_measure_df(pred_lm_df, gt_lm_df):
    ...
    for id in tqdm(common_id_list):
        ...
        for feature in pred_row.columns:
            if feature == 'id':
                continue
            comp_lm_df.loc[id*3, feature+"_gt"] = gt_row[feature].values[0]
            comp_lm_df.loc[id*3+1, feature+"_pred"] = pred_row[feature].values[0]
            comp_lm_df.loc[id*3+2, feature+"_ratio"] = pred_row[feature].values[0] / gt_row[feature].values[0]
...
if __name__ == '__main__':
    ...
    manual_swc_dir = ""
    auto_swc_dir = "/data2/kfchen/tracing_ws/14k_raw_img_data/h01-guided-reconstruction/data/auto8.4k_0510_pruned_resample1um_renamed_0716"
